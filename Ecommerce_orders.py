# -*- coding: utf-8 -*-
"""
Created on Wed May  8 09:49:58 2024
...
os.chdir('/Project Ecommerce Orders Data/Ecommerce Orders Project')
...
#Select a subset of the pauments data where payment type = Credit Card and payment value > 1000
edit_card_payment_data = payments_data[
    (payments_data['payment_type']== 'credit_card')&
    (payments_data['payment_value']>1000)
    ]
#Selec a subset of customers based on customer state = SP
...
#converter month_year from period into string
...
plt.title('Paymenta Value by Month and Year')
plt.xticks(rotation=90, fontsize=8)
plt.yticks(fontsize=8)

#Scatter Plot

#Create the DataFlame
...
plt.xlabel('Payment Value')
plt.ylabel('Payment Installments')
plt.title('Payment Value vc Installments by Customer')
plt.show()
...
ax3.set_title('Payment Value vc Installments by Customer')

fig.tight_layout()

# Save the plots on png file #
